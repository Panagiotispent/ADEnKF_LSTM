...
parser.add_argument('-bs', type=int, metavar='-batch-size',default=120) # 60 (minutes), 24 (hours), 12 (months)
parser.add_argument('-sequence-length', type=int, default=60) # 12 (minutes), 6 (hours), 3 (months)
...
if __name__ == '__main__': #????
    ...
    # train_model(train_loader, model, Ens, num_epochs, optimizer, save_name,pf)
